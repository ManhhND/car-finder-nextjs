  ...
  return (
    <>
      <div className="search-box flex gap-2 rounded-lg border border-gray-3 text-gray-3 mobile:w-full md:w-1/2 px-2 items-center">
        ...
        {loading && 
          <div role="status">
            <svg aria-hidden="true" className="h-8 text-gray-200 animate-spin text-gray-3 fill-gray-2 w-full" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="absolute z-10">
          <div className="flex flex-col gap-4 bg-gray p-2 shadow-lg shadow-black">
            {filteredCars.map((car) => (
              <CarSearchItem key={`car-${car.nid}`} {...car} onStopSearching={stopSearching} />
            ))}
          </div>
        </div>
      }
